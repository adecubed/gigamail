...
export default class Keyboard
{
    constructor()
    {
        ...
        addEventListener('keydown', (_event) =>
        {
            ...
            // GigaMail adaptation: prevent repeat events leaving keys stuck.
            if(!this.pressed.includes(_event.code)) this.pressed.push(_event.code)
            if(!this.pressed.includes(_event.key)) this.pressed.push(_event.key)
