...
(function () {
  const DICT = {
    it: {
      ...
      ai_config_desc: "Scegli come ADE Mail genera le bozze:",
      ai_login_chatgpt: "Login con ChatGPT", ai_recommended: "consigliato",
      ai_chatgpt_sub: "Usa il tuo abbonamento ChatGPT Plus. Nessuna API key.",
      ai_check_status: "Verifica stato…", login: "Login",
      ai_apikey: "API Key OpenAI",
      ai_apikey_sub: "Per utenti avanzati. Richiede account OpenAI con credito.",
      // mail detail / liste
    ...
    en: {
      ...
      ai_config_desc: "Choose how ADE Mail generates drafts:",
      ai_login_chatgpt: "Login with ChatGPT", ai_recommended: "recommended",
      ai_chatgpt_sub: "Use your ChatGPT Plus subscription. No API key.",
      ai_check_status: "Checking status…", login: "Login",
      ai_apikey: "OpenAI API Key",
      ai_apikey_sub: "For advanced users. Requires an OpenAI account with credit.",
